...
[![PythonIcon.png](images/c/c2/PythonIcon.png)](File_PythonIcon.html)[transformTOP\_Class](https://docs.derivative.ca/TransformTOP_Class "TransformTOP Class")
## Contents
* [1 Summary](#Summary)
* [2 Parameters - Transform Page](#Parameters_-_Transform_Page)
* [3 Parameters - Tile Page](#Parameters_-_Tile_Page)
...
## Info CHOP Channels
Extra Information for the Transform TOP can be accessed via an [Info CHOP](Info_CHOP.html "Info CHOP").
...
Retrieved from "<https://docs.derivative.ca/index.php?title=Transform_TOP&oldid=26805>"
