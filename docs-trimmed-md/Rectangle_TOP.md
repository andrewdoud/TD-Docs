...
[![PythonIcon.png](images/c/c2/PythonIcon.png)](File_PythonIcon.html)[rectangleTOP\_Class](https://docs.derivative.ca/RectangleTOP_Class "RectangleTOP Class")

## Contents

* [1 Summary](#Summary)
* [2 Parameters - Rectangle Page](#Parameters_-_Rectangle_Page)
...
Extra Information for the Rectangle TOP can be accessed via an [Info CHOP](Info_CHOP.html "Info CHOP").
