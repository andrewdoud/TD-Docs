...
In CHOP - TouchDesigner Documentation
...
[![PythonIcon.png](images/c/c2/PythonIcon.png)](File_PythonIcon.html)[inCHOP\_Class](https://docs.derivative.ca/InCHOP_Class "InCHOP Class")
## Contents
* [1 Summary](#Summary)
...
## Info CHOP Channels
Extra Information for the In CHOP can be accessed via an [Info CHOP](Info_CHOP.html "Info CHOP").
...
Retrieved from "<https://docs.derivative.ca/index.php?title=In_CHOP&oldid=24045>"
