...
[![PythonIcon.png](images/c/c2/PythonIcon.png)](File_PythonIcon.html)[holdCHOP\_Class](https://docs.derivative.ca/HoldCHOP_Class "HoldCHOP Class")

## Contents

* [1 Summary](#Summary)
* [2 Parameters - Sample Page](#Parameters_-_Sample_Page)
...
Extra Information for the Hold CHOP can be accessed via an [Info CHOP](Info_CHOP.html "Info CHOP").
...
Retrieved from "<https://docs.derivative.ca/index.php?title=Hold_CHOP&oldid=24044>"
